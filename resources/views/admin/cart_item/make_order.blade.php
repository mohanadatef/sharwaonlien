...
<div class="wrapper">
    ...
    <div class="content-wrapper">
       ...
       <br>
            <div align="center">{{ __('Make Order') }}</div>
            <form action="{{url('admin/cart_item/make_order/index')}}" enctype="multipart/form-data" method="Get" style="margin-right: 30px;margin-left: 30px">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    category type : <select id="category_type_id" name="category_type_id" type="category_type_id" class="form-control"  >
                        <option value="" selected disabled>Select</option>
