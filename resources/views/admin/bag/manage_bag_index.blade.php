                                ...
                                <table id="example1" class="table table-striped table-bordered table-hover">
                                    ...
                                    @foreach($bag as $manage_bags)
                                        <tr>
                                            ...
                                            @if($manage_bags->cost_buy == 0 || $manage_bags->count_item == 0)
                                                <td class="center">0</td>
                                            @else
                                                <td class="center">{{ (int)($manage_bags->cost_buy / $manage_bags->count_item)}}</td>
                                            @endif
                                            <td class="center">{{ $manage_bags->cost_profit }}</td>
                                            <td class="center">
                                                @if($manage_bags->cost_buy != 0 && $manage_bags->cost_profit != 0)
                                                    ...
                                                    @endpermission
                                                @elseif($manage_bags->cost_buy == 0 || $manage_bags->cost_profit == 0)
                                                    @permission('bag-manage-edit')
                                                    <a href="{{ url('/admin/manage_bag/edit/'.$manage_bags->id)}}"><i
