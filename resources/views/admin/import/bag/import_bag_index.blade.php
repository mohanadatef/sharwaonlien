                            ...
                            <table id="example1" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($templet_bag as $templet)
                                    <tr>
                                        ...
                                        <td class="center">{{ $templet->supplier }}</td>
                                        <td class="center">{{ $templet->weight }}</td>
                                        <td class="center">{{ $templet->cost_profit }}</td>
                                        <td class="center">{{ $templet->cost_buy }}</td>
                                        <td class="center">{{ $templet->user_buy }}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
